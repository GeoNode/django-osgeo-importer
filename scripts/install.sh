...
sudo apt-get install -y libproj0 libproj-dev postgresql-plpython-9.3 python-numpy python-dateutil libjpeg62 libjpeg-dev zlib1g-dev python-dev libxml2 libxml2-dev libxslt1-dev libpq-dev
