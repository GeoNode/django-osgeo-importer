...
DEFAULT_SUPPORTED_EXTENSIONS = ['shp', 'shx', 'prj', 'dbf', 'kml', 'geojson', 'json',
                                ...
                                'sld', 'ntf', 'nitf']
VALID_EXTENSIONS = getattr(
    settings, 'OSGEO_IMPORTER_VALID_EXTENSIONS', DEFAULT_SUPPORTED_EXTENSIONS)
...
class OGRImport(Import):
    ...
    def import_file(self, *args, **kwargs):
        ...
        gdal.UseExceptions()
        configuration_options = kwargs.get(
            'configuration_options', [{'index': 0}])
