...
class GeoNodePublishHandler(ImportHandlerMixin):
    ...
    def handle(self, layer, layer_config, *args, **kwargs):
        ...
        new_layer_kwargs = {
            ...
            'owner': owner,
            'uuid': layer_uuid,
#             'bbox_x0': Decimal(-125.0),
#             'bbox_x1': Decimal(-67.0),
#             'bbox_y0': Decimal(25.0),
#             'bbox_y1': Decimal(47.5)
        }

#         new_layer, created = Layer.objects.get_or_create(name=layer_name, defaults=new_layer_kwargs)
